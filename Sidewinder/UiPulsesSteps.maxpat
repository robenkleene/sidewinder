        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 8.0, 56.0, 95.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "float" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 8.0, 96.0, 41.0, 48.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 40.0, 320.0, 34.0, 22.0 ],
                    "text": "gate"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 40.0, 232.0, 29.5, 22.0 ],
                    "text": ">"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 160.0, 320.0, 34.0, 22.0 ],
                    "text": "gate"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "int", "int" ],
                    "patching_rect": [ 128.0, 176.0, 29.5, 22.0 ],
                    "text": "t i i"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 160.0, 232.0, 29.5, 22.0 ],
                    "text": "<"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "int", "int" ],
                    "patching_rect": [ 8.0, 176.0, 29.5, 22.0 ],
                    "text": "t i i"
                }
            }
        ],
