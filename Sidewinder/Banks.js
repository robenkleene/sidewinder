...
var ENCODERS = [
["Main",         "Tab",  "PresetsSelect",          "$1-Pulses",              "$1-Steps",             "$1-Rotate",           "$1-Pitch",              "$1-Vel",               "$1-Dur"],
...
["-",  "RandomizeNotes",     "RandomizeAccent",  "RandomizeNotesScaleRandTonal",  "-",           "-",                "RandomizeNotesScaleRand",  "RandomizeNotesScaleChord"],
];
