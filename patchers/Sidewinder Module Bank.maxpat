...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 952.0, 31.0, 20.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.0, 1424.0, 86.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 736.0, 1416.0, 71.0, 20.0 ],
					"text" : "s #0channel4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 696.0, 1384.0, 71.0, 20.0 ],
					"text" : "s #0channel3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 656.0, 1352.0, 71.0, 20.0 ],
					"text" : "s #0channel2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 616.0, 1320.0, 71.0, 20.0 ],
					"text" : "s #0channel1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.0, 1248.0, 76.0, 20.0 ],
					"text" : "r #0randomize"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 1448.0, 78.0, 20.0 ],
					"text" : "s #0randomize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 616.0, 1280.0, 175.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 1248.0, 576.0, 168.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 1544.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 8.0, 1512.0, 46.0, 20.0 ],
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 1480.0, 49.0, 20.0 ],
					"text" : "r #0note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 1544.0, 30.0, 30.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-7::obj-1" : [ "live.text[12]", "live.text", 0 ],
			"obj-7::obj-10" : [ "live.text[8]", "live.text[2]", 0 ],
			"obj-7::obj-11" : [ "live.text[13]", "live.text[2]", 0 ],
			"obj-7::obj-6" : [ "live.text[11]", "live.text[1]", 0 ],
			"obj-7::obj-7" : [ "Velocity Amount", "Amount", 0 ],
			"obj-7::obj-8" : [ "live.text[10]", "live.text[2]", 0 ],
			"obj-7::obj-9" : [ "live.text[9]", "live.text[2]", 0 ],
			"parameterbanks" : 			{
